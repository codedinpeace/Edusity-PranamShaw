...
useGSAP(()=>{
  ...
  return (
    ...
    <div className=''>
        ...
        <span className=''>  <button className='flex mt-7 text-xl max-md:text-[16px] max-md:px-7 max-md:py-2 bg-white text-black px-10 py-4 mx-auto group gap-3 rounded-full items-center border-2 border-white hover:bg-transparent hover:text-white cursor-pointer transition-all'>Explore More <img src={btnArrow} className='w-7 group-hover:invert-100 mt-0.5' alt="" /></button></span>
          </h1>
        </div>
        </div>
      </div>
