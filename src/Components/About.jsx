   ...
   return (
    ...
    <div id="About" className='About mt-30'>
        ...
        <img src={PlayBtn} onClick={()=>{setPlayState(true)}} className='w-20 max-lg:w-10 absolute top-[50%] left-[45%] right-[50%] bottom-[50%]' alt="" />
           ...
           <a href="#Contact"> <button className='bg-blue-800 text-white w-50 py-3 cursor-pointer border-3 border-blue-800 text-xl mt-7 rounded-xl hover:bg-transparent hover:text-black transition-all duration-100 max-xl:mx-auto max-md:text-[16px] max-md:w-30 max-md:py-2'>Enroll Now</button></a>
        </div>
        </div>  
    </div>
)
